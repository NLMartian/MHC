...
<?php else : ?>
							...
							<div class="control-group">
								<label class="control-label" for="url"><?php _e("<!--:zh-->手机<!--:--><!--:en-->Mobile<!--:-->") ?>  *</label>
							...
							<div class="control-group">
								<label class="control-label" for="where"><?php _e("<!--:zh-->居住国家<!--:--><!--:en-->Country of residence<!--:-->") ?></label>
								<div class="controls">
...
<?php endif // REFERENCE: * if ( $user_ID ) ?>
							...
							<div class="control-group">
								...
								<div class="controls"><textarea id="comment" name="comment" class="text required" cols="45" rows="8" tabindex="6"></textarea></div>
							</div>
